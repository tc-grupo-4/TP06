...
\subsubsection{Polos y ceros de la ganancia de lazo abierto.}
...
en la inecuación \ref{eq:1_3}, se decide tomar el capacitor $C_{3}=1(\mu F)$,
...
por eso que los valores quedarán:
