...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.5]{\string"../Ex1/Resources/Controlador de amplitud de oscilación\string".png}
\par\end{centering}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.5]{../Ex1/Resources/Esquemático}
\par\end{centering}
\caption{Esquemático}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.35]{../Ex1/Resources/Oscilación}
\par\end{centering}
